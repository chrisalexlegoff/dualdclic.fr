...
const Mission = ({ mission }) => {
  return (
    <div
      ...
      className="bg-blanc max-w-9xl mx-auto grid lg:grid-cols-2 items-center text-center pt-6 py-32 lg:py-48"
    >
      <div className="py-32 lg:pb-0 lg:pt-24 row-start-1 lg:col-span-2 lg:bg-about-mission bg-about-mission-mobile">
        ...
        <div className="flex flex-wrap justify-center items-center mx-auto mb-32 mt-24 w-full">
          {mission.services.map((miss, index) => (
            <div
              key={miss.id}
              className="services w-full md:w-[300px] flex flex-col justify-center items-center rounded-xl bg-[#fafafb] py-16 m-4"
            >
